...
| :-----: | :------------: | :-----------: |
| **Definiție** | O rețea digitală descentralizată care folosește criptografia pentru a securiza tranzacțiile financiare | Un protocol de plată de tip al doilea strat care funcționează peste blockchain-ul Bitcoin, permițând tranzacții mai rapide și mai ieftine |
...
| **Dezavantaje** | Timp de tranzacție lent. Taxe mari pentru anumite tipuri de tranzacții. Complex pentru începători | Necesită încredere în operatorii de canal. Încă experimentală și nu este adoptată pe scară largă. Necesită tranzacție on-chain pentru deschiderea și închiderea canalelor |

<br/>

### ***8.2 Diferite tipuri de portofele Lightning***    

Un portofel Lightning este puțin diferit față de un portofel Bitcoin, deși îndeplinește aceeași funcție: primirea și trimiterea de bitcoini. Diferența este că un portofel Lightning îți permite să trimiți bitcoini pe Lightning Network, care este un al doilea strat deasupra rețelei Bitcoin.
...
### _8.2.1 Portofele self-custodial vs custodial_

Portofelele Lightning pot fi împărțite în categorii foarte specifice, dar pentru simplitate, le vom împărți în două: self-custodial și custodial.

La fel ca portofelele Bitcoin, un portofel Lightning self-custodial este acela în care tu controlezi cheile portofelului, în timp ce un portofel Lightning custodial este acela în care altcineva controlează cheile.
...
Acest lucru poate fi acceptabil pentru sume mici, deși este recomandat să folosești un portofel self-custodial odată ce ai înțeles tehnologia.

În cele ce urmează, vom vorbi doar despre portofele Lightning self-custodial.
...
Configurarea unui portofel Bitcoin Lightning self-custodial este la fel ca configurarea unui portofel Bitcoin on-chain self-custodial.

<br/>

**Exercițiu de clasă** - Opțiunea 1. Descarcă un nou portofel Lightning self-custodial
...
5. ⭐ Generează o factură Lightning, o adresă sau un cod QR pentru a primi bitcoini. Transferă bitcoini în portofelul tău. Cu un portofel self-custodial, nu poți cumpăra întotdeauna bitcoini direct cu fiat, așa că poate fi nevoie să îi achiziționezi și să îi transferi dintr-un exchange mai întâi.
