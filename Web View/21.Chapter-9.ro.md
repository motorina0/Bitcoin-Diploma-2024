...
Evenimentele de înjumătățire sunt programate în protocolul Bitcoin, făcând programul de emisie al bitcoin-ului previzibil și transparent.

<div><p align="center"><img src="Images/19.Chapter-9/35.Satoshi-marks-calendar-for-a-halving-event-v1.png" width="300"></div>

- 💡 **Programul de emisie al Bitcoin** este planul prestabilit și public pentru eliberarea de noi bitcoini în circulație, conceput pentru a menține raritatea Bitcoin în timp.
...
- Satoshi Nakamoto, creatorul Bitcoin, a minat blocul inițial, care a conținut un total de 50 de bitcoini.
...
- 💡 Găsind un hash de bloc valid, un miner demonstrează că a efectuat munca necesară pentru a adăuga noul bloc la blockchain și este plătit cu o recompensă în bitcoini, plus comisioane de tranzacție, pentru efortul său. Proof-of-Work (PoW) este metoda pe care rețeaua Bitcoin o folosește pentru a valida tranzacțiile și a adăuga noi blocuri la blockchain.
...
4. ⭐ **Obținerea recompenselor:** <br>
    În final, primesc bitcoini nou creați și comisioane de tranzacție pentru adăugarea cu succes a blocului la blockchain.
